...
# Loading the Excel Spreadsheet ready for modeling and forecasting
...
for gender_category in gender_categories:
    ...
    # Renaming and assigning my columns to specified column names to match with FB Prophet requirements and work with
    # the FB Prophet model successfully.
